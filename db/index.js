    ...
    if (parseInt(rows[0].count) === 0) {
      await client.query(`
        ...
        (
          ...
          'Technical',
          ARRAY[''Technical SEO'', ''Checklist'', ''Performance''],
          TRUE,
          NOW() - INTERVAL ''12 days''
        ),
        (
          'local-seo-guide',
          'Local SEO: How to Dominate Your City Search Results',
          'If your business serves a local market, these strategies will put you in front of customers who are ready to buy right now.',
          '<p>Local SEO is one of the highest-ROI investments a local business can make. When someone searches for your service in your city, you want to be the first result they see.</p><h2>Google Business Profile</h2><p>Claim and fully optimize your listing. Add photos, respond to reviews, and post regular updates. This alone can dramatically increase local visibility.</p><h2>NAP Consistency</h2><p>Your Name, Address, and Phone number must be identical across every directory, your website, and social profiles.</p><h2>Local Citations</h2><p>Get listed in reputable local directories. Quality matters more than quantity.</p><h2>Reviews</h2><p>Actively ask satisfied customers for Google reviews. A steady stream of authentic reviews is a strong local ranking signal.</p>',
          'Local SEO',
          ARRAY[''Local SEO'', ''Google Business'', ''Rankings''],
          TRUE,
